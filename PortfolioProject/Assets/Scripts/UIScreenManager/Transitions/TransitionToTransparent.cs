...
namespace Kborod.UI.UIScreenManager.Transitions
{
    public class TransitionToTransparent : ITransition
    {
        ...
        private const float ALPHA_MIN = 0.005f;
        ...
        public TransitionToTransparent(GameObject gameObject, Image stretchedImagePrefab)
        {
            ...
            if (_gameObject.GetComponent<CanvasGroup>() != null)
                throw new Exception("GameObject already contains CanvasGroup. TransitionToTransparent cant initialize.");
        ...
        private void CreateBlockClickPanel(Image prefab)
        {
            ...
            _blockClicksPanel.name = "TransitionOverlay";
            EnableInteractable();
        }
